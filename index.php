...
<div class="col-md-3 col-sm-6 container" >
        ...
        $user = $_GET['user'];  
            ...
            {
                 echo "<div class=' card alert alert-danger' style=' margin-right:300px;width:300px;'>Wrong Pin</div>" ; 
            }
...
<div class=" row col-1">
                ...
                <span class="note" style="color:gold;font-size:25px;" >MembershipForm  </span>
            </div> 
       ...
       <form method="post"   >
												...
												<div class=" input-group custom">
													<input type="text" class="form-control card  " placeholder="Full name" name="name" style="border-radius:50px;">
           ...
           <div class=" input-group custom">
													<input type="tel" class="form-control card  " placeholder="+233540202096" name="tel" style="border-radius:50px;">
           ...
           <div class=" input-group custom">
													<input type="email" class="form-control card  " placeholder="********@gmail.com" name="email" style="border-radius:50px;">
							...
							<div class="col-sm-12 col-md-10 input-group custom">
								<input class="form-control date-picker" name="date" placeholder="Date of birth" type="text" required style="border-radius:5px;">
                                <span class="input-group-text"><i class="ti ti-calendar"></i></span>
							</div>
						
           <div class="input-group custom">
													<select name="gender" style="border-radius:50px;"  class="form-control card ">
           ...
           <div class="input-group custom">
													<input class="form-control card " name="program" placeholder="Program" type="text" required style="border-radius:50px;">
													<div class="input-group-append custom">
														<span class="input-group-text"><i class="icon-copy ti-ruler-alt-2"></i></span>
													</div>
												</div>
       
												 <div class="input-group custom">
													<input class="form-control card " name="pos" placeholder="Place of stay" type="text" required style="border-radius:50px;">
													<div class="input-group-append custom">
